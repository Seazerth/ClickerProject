...
namespace ClickerWebProject.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurentPrice = table.Column<long>(type: "INTEGER", nullable: false),
                    Quantity = table.Column<long>(type: "INTEGER", nullable: false),
                    ApplicationUserId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBoost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBoost_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBoost_ApplicationUserId",
                table: "UserBoost",
